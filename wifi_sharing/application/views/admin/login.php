...
<head>
  ...
  <link href="<?=base_url()?>/js/plugins/prism/prism.css" type="text/css" rel="stylesheet" media="screen,projection">
...
<body class="cyan">
  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel">
      <form class="login-form" method="post" action="<?=base_url()?>index.php/admin_cmz/signin/">
        <div class="row">
          <div class="input-field col s12 center">
            <img src="<?=base_url()?>/images/logo11.jpg" alt="" class="responsive-img valign profile-image-login">
            <p class="center login-form-text">PORTAL WIFI SHARING <br/>SMKN 11 BDG</p>
          </div>
        </div>
        ...
        <div class="row">
          <div class="input-field col s12">
              <button type="submit" class="btn waves-effect waves-light col s12">Lanjutkan</button>
          </div>
        </div>
        <div class="row">
          <div class="input-field col s12 m12 l12">
            <p class="margin medium-small">*Isi informasi diatas untuk melanjutkan</p>
          </div>
