    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title"> Apps
                <small>Pick Apps for your bussiness</small>
            </h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
            ...
            <div class="row margin-bottom-40 about-header">
                <div class="col-md-12">
                    <h1>ERP ISSAC</h1>
                    <h2>Make Your Business Better Easier, Faster, Realtime and Integrated</h2>
                    <button type="button" class="btn btn-danger">Pick Apps For Your Business Now</button>
                </div>
            </div>
            <!-- END CONTENT HEADER -->
            <!-- BEGIN CARDS -->
            <div class="row margin-bottom-20">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="portlet light" style="height:300px">
                        <div class="card-icon profile-userpic">
                            <img src="<?=base_url("assets/jqwidgets/".$row->icon)?>" class="img-responsive">
                        </div>
                        ...
                        <button type="button" class="btn btn-circle green btn-sm">Install</button>
                        <button type="button" class="btn btn-circle blue btn-sm" onclick="location.href='<?=site_url()?>/<?=$row->url?>'">Open</button>
                    </div>
                </div>
                <?php
                }
            ...
            <div class="row margin-bottom-20 stories-cont">
                <div class="col-lg-3 col-md-6">
                    <div class="portlet light">
                        <div class="photo">
                            <img src="<?=base_url("assets/material/")?>/assets/pages/media/users/teambg1.jpg" alt="" class="img-responsive" /> </div>
                        <div class="title">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="portlet light">
                        <div class="photo">
                            <img src="<?=base_url("assets/material/")?>/assets/pages/media/users/teambg2.jpg" alt="" class="img-responsive" /> </div>
                        <div class="title">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="portlet light">
                        <div class="photo">
                            <img src="<?=base_url("assets/material/")?>/assets/pages/media/users/teambg5.jpg" alt="" class="img-responsive" /> </div>
                        <div class="title">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="portlet light">
                        <div class="photo">
                            <img src="<?=base_url("assets/material/")?>/assets/pages/media/users/teambg8.jpg" alt="" class="img-responsive" /> </div>
                        <div class="title">
                            <span> Tom Brady </span>
                        </div>
                        <div class="desc">
            ...
            <div class="row about-links-cont" data-auto-height="true">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="about-image" style="background: url(<?=base_url("assets/material/")?>/assets/pages/media/works/img4.jpg) center no-repeat;"></div>
                </div>
            </div>
            <!-- END LINKS BLOCK -->
        </div>
                    ...
                    <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                        ...
                        <ul class="media-list list-items">
                            <li class="media">
                                ...
                                <img class="media-object" src="<?=base_url("assets/material/")?>/assets/layouts/layout/img/avatar3.jpg" alt="...">
                            ...
                            <li class="media">
                                <img class="media-object" src="<?=base_url("assets/material/")?>/assets/layouts/layout/img/avatar1.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="<?=base_url("assets/material/")?>/assets/layouts/layout/img/avatar4.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="media-object" src="<?=base_url("assets/material/")?>/assets/layouts/layout/img/avatar2.jpg" alt="...">
                                <div class="media-body">
                        ...
                        <ul class="media-list list-items">
                            <li class="media">
                                ...
                                <img class="media-object" src="<?=base_url("assets/material/")?>/assets/layouts/layout/img/avatar6.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="<?=base_url("assets/material/")?>/assets/layouts/layout/img/avatar7.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="media-object" src="<?=base_url("assets/material/")?>/assets/layouts/layout/img/avatar8.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="<?=base_url("assets/material/")?>/assets/layouts/layout/img/avatar9.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="media-object" src="<?=base_url("assets/material/")?>/assets/layouts/layout/img/avatar10.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="<?=base_url("assets/material/")?>/assets/layouts/layout/img/avatar11.jpg" alt="...">
                                <div class="media-body">
                    ...
                    <div class="page-quick-sidebar-item">
                        <div class="page-quick-sidebar-chat-user">
                            ...
                            <div class="page-quick-sidebar-chat-user-messages">
                                <div class="post out">
                                    <img class="avatar" alt="" src="<?=base_url("assets/material/")?>/assets/layouts/layout/img/avatar3.jpg" />
                                    <div class="message">
                                ...
                                <div class="post in">
                                    <img class="avatar" alt="" src="<?=base_url("assets/material/")?>/assets/layouts/layout/img/avatar2.jpg" />
                                    <div class="message">
                                        <span class="arrow"></span>
