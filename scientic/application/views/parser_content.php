...
<link rel="stylesheet" href="<?=base_url("assets/jqwidgets")?>/jqwidgets/styles/jqx.arctic.css" type="text/css" />
...
<script type="text/javascript" src="<?=base_url("assets/jqwidgets")?>/jqwidgets/globalization/globalize.js"></script>
...
<script type="text/javascript" src="<?=base_url("assets/jqwidgets")?>/jqwidgets/jqxmaskedinput.js"></script>
