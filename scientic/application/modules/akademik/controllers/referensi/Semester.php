...
class Semester extends CI_Controller {
	 ...
	 {
		 parent::__construct();
		 $this->load->model("referensi/M_semester","model");
		 $this->load->model("M_jqxgrid");
		 $this->M_jqxgrid->setPath("referensi/semester/jqxgrid/datafields.json");
	 }
   ...
   */
	...
	{
		$data["content"] = "referensi/semester/index";
	...
	public function update()
	{
			...
			if(!is_numeric($_POST["aktif"]))
			{
				...
				$this->db->update("semester",array("aktif"=>0));
