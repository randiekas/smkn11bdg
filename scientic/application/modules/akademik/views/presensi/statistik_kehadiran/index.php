							...
							<div id="nested2">
								...
								<div>
									 ...
									 <div id="jqxTabs" style="overflow:hidden;">
										<ul>
										  <li style="margin-left: 30px;">Statistik Presensi Kelas</li>
										  <li>Statistik Presensi Siswa</li>
										  <li>Detail Presensi Siswa</li>
										</ul>

									<div><!--form in div-->
										  <div>
												<div id="jqxGridKelas"></div>
										  </div>
									 </div>
									<div><!--form in div-->
										  <div>
...
$(document).ready(function(){
	...
	function fillPresensi()
	{
		...
		jqxGridKelas.jqxGrid('source')._source.data.idtingkat = $("#siswa_tingkat").val();
		jqxGridKelas.jqxGrid('source')._source.data.idtahunajaran = $("#siswa_idtahunajaran").val();
		jqxGridKelas.jqxGrid('source')._source.data.idsemester = $("#idsemester").val();
		jqxGridKelas.jqxGrid('source')._source.data.tanggal_awal= tanggal_awal;
		jqxGridKelas.jqxGrid('source')._source.data.tanggal_akhir= tanggal_akhir;
		jqxGridKelas.jqxGrid('updatebounddata');
