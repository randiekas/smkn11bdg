...
<div class="form-group form-group-sm">
	<label for="idproses" class="control-label col-sm-4">PSB</label>
	<div class="col-sm-8">
		<select name="idproses" class="form-control" id="idproses" required>
			<option value=""> -- Pilih PSB --</option>
			<?php
			foreach($this->db->get("prosespenerimaansiswa")->result() as $row)
			{
				echo "<option value='{$row->replid}'>{$row->kodeawalan} - {$row->proses}</option>";
			}
			?>
		</select>
...
<div class="form-group form-group-sm">
	<label for="idkelompok" class="control-label col-sm-4">Kelompok</label>
	<div class="col-sm-8">
		<select name="idkelompok" class="form-control" id="idkelompok" required>
			<option value=""> -- Pilih Kelompok --</option>
			<?php
			foreach($this->db->get("kelompokcalonsiswa")->result() as $row)
			{
				echo "<option value='{$row->replid}'>{$row->kelompok} - {$row->keterangan}</option>";
			}
			?>
		</select>
	</div>
...
<div class="form-group form-group-sm">
	<label for="pilihanpertama" class="control-label col-sm-4">Pilihan Pertama</label>
	<div class="col-sm-8">
		<select name="pilihanpertama" class="form-control" id="pilihanpertama" required>
			<?php
			foreach($this->db->get("jurusan")->result() as $row)
			{
				echo "<option value='{$row->kode}'>{$row->jurusan}</option>";
			}
			?>
		</select>
	</div>
...
<div class="form-group form-group-sm">
	<label for="pilihankedua" class="control-label col-sm-4">Pilihan Kedua</label>
	<div class="col-sm-8">
		<select name="pilihankedua" class="form-control" id="pilihankedua" required>
			<?php
			foreach($this->db->get("jurusan")->result() as $row)
			{
				echo "<option value='{$row->kode}'>{$row->jurusan}</option>";
...
<div class="form-group form-group-sm">
	<label for="nopendaftaran" class="control-label col-sm-4">NO Pendaftaran</label>
	<div class="col-sm-8">
		<input type="text" class="form-control" id="nopendaftaran" placeholder="" name="nopendaftaran" required>
	</div>
</div>
<div class="form-group form-group-sm">
...
<div class="form-group form-group-sm">
	...
	<div class="col-sm-8">
		<select name="asalsekolah" class="form-control" id="asalsekolah" required>
			<option value=""> -- Pilih Asal Sekolah --</option>
			<?php
			foreach($this->db->get("asalsekolah")->result() as $row)
			{
				echo "<option value='{$row->sekolah}'>{$row->sekolah}</option>";
			}
			?>
		</select>
...
<div class="form-group form-group-sm">
	...
	<div class="col-sm-8">
		<input type="date" class="form-control" id="tglijasah" placeholder="" name="tglijasah">
	</div>
</div>
<div class="form-group form-group-sm">
