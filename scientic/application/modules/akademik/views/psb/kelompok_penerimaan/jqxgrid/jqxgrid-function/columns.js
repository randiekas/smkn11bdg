[
	{ text: "Kode PMB", datafield: "idproses",width: "15%",
		...
		createeditor: function (row, column, editor) {
			...
			{
				datatype: "json",
				localdata: <?=$pmb = getDataField("prosespenerimaansiswa","replid","kodeawalan")?>,
				datafields: [
					{ name: 'value' },
					{ name: 'label' }
				],
	...
	{ text: "Kelompok", datafield: "kelompok",width: "15%"},
	{ text: "Kapasitas", datafield: "kapasitas",width: "20%" },
