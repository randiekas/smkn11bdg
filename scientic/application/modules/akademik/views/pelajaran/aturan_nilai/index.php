...
$(document).ready(function(){
	$('#mainSplitter').jqxSplitter({ width: '100%', height: '99%', orientation: 'horizontal', panels: [{ size: '40%' }] });
	$('#secondNested').jqxSplitter({ width: '100%', height: '100%',  orientation: 'vertical', panels: [{ size: '40%'}] });
	...
	<?=$this->load->view("jqxgridBobot.js",array(),TRUE)?>
