...
class Satuan_kerja extends CI_Controller {
	 ...
	 {
		 parent::__construct();
		 $this->load->model("referensi/M_satuan_kerja","model");
		 $this->load->model("M_jqxgrid");
		 $this->M_jqxgrid->setPath("referensi/satuan_kerja/jqxgrid/datafields.json");
	 }
   ...
   */
	...
	{
		$data["content"] = "referensi/satuan_kerja/index";
