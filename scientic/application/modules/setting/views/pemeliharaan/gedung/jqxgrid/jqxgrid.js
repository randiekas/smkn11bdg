...
var source =
{
                 ...
                 $.ajax({
                     ...
                     success: function (data, status, xhr) {
						 ...
						 if(data.status=="success")
						 {
							...
							alert.alert("Gagal Menyimpan","Kode gedung telah digunakan, silahkan ubah dengan kode gedung yang lain.",function(){})
						}
                     },
                     error: function (data,status) {
  ...
  deleterow: function (ids,commit) {
      ...
      rowsSelected.forEach(function(e){
		...
		deleterow = deleterow+currItem.kd_gedung+"("+currItem.nama_gedung+"),";
        x++;
      });
