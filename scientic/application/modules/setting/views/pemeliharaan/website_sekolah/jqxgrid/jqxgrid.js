...
var source =
{
  ...
  deleterow: function (ids,commit) {
      ...
      rowsSelected.forEach(function(e){
        rows[x] = elementJqxGridReligion.jqxGrid('getrowdata',e).id;
		currItem = elementJqxGridReligion.jqxGrid('getrowdata', e);
		deleterow = deleterow+currItem.nama_module+"("+currItem.link+"),";
        x++;
      });
	  console.log(rows);
...
{
	elementJqxGridReligion.jqxGrid('sortby', 'kode', 'asc');
    elementJqxGridReligion.jqxGrid('expandallgroups');
});        