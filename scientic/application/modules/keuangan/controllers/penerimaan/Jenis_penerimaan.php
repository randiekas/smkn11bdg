...
class Jenis_penerimaan extends CI_Controller {
	 ...
	 {
		 parent::__construct();
		 $this->load->model("penerimaan/M_jenis_penerimaan","model");
		 $this->load->model("M_jqxgrid");
		 $this->M_jqxgrid->setPath("penerimaan/jenis_penerimaan/jqxgrid/datafields.json");
	 }
   ...
   */
	...
	{
		$data["content"] = "penerimaan/jenis_penerimaan/index";
